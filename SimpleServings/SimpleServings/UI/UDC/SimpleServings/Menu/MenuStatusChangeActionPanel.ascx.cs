...
{
    public partial class MenuStatusChangeActionPanel : System.Web.UI.UserControl
    {
        ...
        private void PopStatusList(int keyID, SimpleServingsLibrary.Shared.Code.CodeTypes codeType)
        {
            ...
            try {                                
                ...
                //int index = ShortCodeList.Count - 1;   //need remove "Delete" ,which is the last order in Sp_Get_CodeByCodeTypeAndUserGroup 'MenuStatus' ,1    
                //ShortCodeList.RemoveAt(index);
        ...
        protected void dlStatusList_ItemDataBound(object sender, DataListItemEventArgs e)
        {
            ...
            string url = string.Format("~/UI/Page/SimpleServings/Menu/MenuStatusChangeSubmission.aspx?MenuID={0}&StatusID={1}",Convert.ToInt32(lblKeyID.Text),codeID);
